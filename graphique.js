...
// Taille de l'image en cm soit une feuille A4
    ...
    var PointtoGraph = function (X) {
        return new point(XtoGraph.call(this, X.x), YtoGraph.call(this, X.y));
    }
    ...
    this.GraphtoX = function (X) {
        ...
        X = ((X ) / _Rapport - this.Origin.x) * ReductionImage + this.Xmin - 0.7;
        if (X < this.Xmin)
            return this.Xmin;
    ...
    this.GraphtoY = function (Y) {
        ...
        Y = ((this.canvas.clientHeight - Y ) / _Rapport - this.Origin.y) * ReductionImage + this.Ymin - 0.7;
        if (Y < this.Ymin)
